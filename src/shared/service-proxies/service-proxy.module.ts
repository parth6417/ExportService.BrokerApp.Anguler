...
@NgModule({
    providers: [
        ApiServiceProxies.AppInvoicesServiceProxy,        
        ApiServiceProxies.AppOperationsServiceProxy,        
        ApiServiceProxies.AppExchangeRatesServiceProxy,        
        ApiServiceProxies.AppCustomersServiceProxy,        
        ApiServiceProxies.AppInsuranceCommissionServiceProxy,        
        ApiServiceProxies.AppSecurityCommissionServiceProxy,        
        ApiServiceProxies.AppCustomersPoliciesServiceProxy,        
        ApiServiceProxies.AppRequirementsTypesServiceProxy,        
        ApiServiceProxies.AppCommoditesTypesServiceProxy,        
        ApiServiceProxies.AppSecurityRequirementsServiceProxy,        
        ApiServiceProxies.AppPoliciesServiceProxy,        
        ApiServiceProxies.AppProvidersServiceProxy,        
        ApiServiceProxies.AppProvidersServiceTypesServiceProxy,        
